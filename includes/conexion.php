...
require 'includes/conexion.php';  // Asegúrate que este archivo contiene la conexión correcta a PostgreSQL
require('fpdf.php');  // Verifica que esta librería está correctamente incluida
